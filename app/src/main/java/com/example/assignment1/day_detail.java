...
import com.example.assignment1.WeekActivity;

public class day_detail extends AppCompatActivity {
    ...
    private void setupUIViews(){
        listView = findViewById(R.id.ListView_day_detail);
        toolbar = findViewById(R.id.toolbar_day_detail);
    }
    ...
    private void setupListView(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(day_detail.this, PreferredDay, PreferredTime);
    ...
    public class SimpleAdapter extends BaseAdapter {
        ...
        private LetterImageViews letterImageView;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null){
                convertView = layoutInflater.inflate(R.layout.activity_day_detail_single_item, null);
            }

            subject = convertView.findViewById(R.id.TextViewDayDetails);
            time = convertView.findViewById(R.id.tvTimeDayDetail);
            letterImageView = convertView.findViewById(R.id.ImageViewDayDetails);
